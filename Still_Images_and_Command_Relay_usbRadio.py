...
class TakePicture(threading.Thread):
    ...
    def run(self):
	   ...
	   # print "Width", settings[0]
	   # print "Height", settings[1]
  	   # print "Sharpness", settings[2]
	   # print "Brightness", settings[3]
	   # print "Contrast", settings[4]
	   # print "Saturation", settings[5]
	   # print "ISO", settings[6]
...
class main:
    ...
    def requestedImage(self):
        ...
        try:
            ...
            while(temp.split(';')[0] != "A" and time.time() < killTime):
		print temp
...
# imagetosend = self.ser.read(15)                  # Determine which picture to send
	...
	time.sleep(2)
	self.ser.write('Testuinsndolnsd\n')
        self.ser.write('A\n')
        try:
    ...
    def getCameraSettings(self):
        ...
        try:
		    ...
		    print "Width", settingsLst[0]
		    print "Height", settingsLst[1]
	  	    print "Sharpness", settingsLst[2]
		    print "Brightness", settingsLst[3]
		    print "Contrast", settingsLst[4]
		    print "Saturation", settingsLst[5]
		    print "ISO", settingsLst[6]
                    self.ser.write('B\n')
                    self.ser.reset_input_buffer()
	except Exception, e:
            print str(e)
